...
export const s = StyleSheet.create({
  ...
  // ── Feed mode toggle ──────────────────────────────────────────────────────
  feedModeBar:       { flexDirection: 'row', marginHorizontal: 16, marginTop: 10, marginBottom: 4, borderRadius: 10, backgroundColor: 'rgba(255,255,255,0.05)', padding: 3 },
  feedModeBtn:       { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 8, borderRadius: 8 },
  feedModeBtnActive: { backgroundColor: C.card },
  feedModeTxt:       { fontSize: 12, fontWeight: '600', color: C.muted },
  feedModeTxtActive: { color: C.white },
  feedSearchRow:     { flexDirection: 'row', alignItems: 'center', marginHorizontal: 16, marginTop: 6, marginBottom: 4, paddingHorizontal: 12, paddingVertical: 9, borderRadius: 10, backgroundColor: 'rgba(255,255,255,0.06)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)' },
  feedSearchInput:   { flex: 1, fontSize: 14, color: '#ffffff', paddingVertical: 0 },
  ...
  ocrCacheTxt:   { flex: 1, fontSize: 11, color: '#A0A0A0' },
  ocrRescanBtn:  { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 6, borderWidth: 1, borderColor: 'rgba(255,255,255,0.12)', backgroundColor: 'rgba(255,255,255,0.05)' },
  ocrRescanTxt:  { fontSize: 11, fontWeight: '600', color: '#A0A0A0' },
  submitDbBtn:    { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginHorizontal: 16, marginTop: 20, marginBottom: 8, paddingVertical: 14, borderRadius: 12, backgroundColor: 'rgba(0,121,107,0.18)', borderWidth: 1, borderColor: 'rgba(0,121,107,0.4)' },
  submitDbBtnTxt: { fontSize: 14, fontWeight: '700', color: '#ffffff' },
  submitItemCount:{ fontSize: 11, color: '#A0A0A0', marginBottom: 10 },
  submitErrorTxt: { fontSize: 12, color: '#ff6b6b', marginBottom: 10 },
  ...
  historySectionLabel:  { fontSize: 10, fontWeight: '800', color: '#A0A0A0', letterSpacing: 1.2, textTransform: 'uppercase' },
  historyCount:         { fontSize: 11, color: '#A0A0A0' },
  historyDayLabel:      { fontSize: 11, fontWeight: '700', color: '#A0A0A0', letterSpacing: 0.8, textTransform: 'uppercase', marginTop: 16, marginBottom: 8, paddingHorizontal: 2 },
  historyEmpty:         { alignItems: 'center', gap: 10, paddingVertical: 32 },
  historyEmptyTxt:      { fontSize: 13, color: '#A0A0A0', textAlign: 'center', lineHeight: 20 },
  historyCard:          { backgroundColor: 'rgba(255,255,255,0.04)', borderRadius: 14, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.07)' },
  historyCardTop:       { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 3 },
  historyRestaurant:    { fontSize: 11, fontWeight: '700', color: '#00796b', textTransform: 'uppercase', letterSpacing: 0.5, flex: 1, marginRight: 8 },
  historySourceBadge:   { backgroundColor: 'rgba(0,200,83,0.12)', borderRadius: 5, paddingHorizontal: 6, paddingVertical: 2 },
  historySourceBadgeUpl:{ backgroundColor: 'rgba(255,167,38,0.12)' },
  historySourceTxt:     { fontSize: 9, fontWeight: '700', color: '#00e676', letterSpacing: 0.3 },
  historySourceTxtUpl:  { color: '#ffb74d' },
  historyItemName:      { fontSize: 15, fontWeight: '700', color: '#ffffff', marginBottom: 10, lineHeight: 20 },
  historyMacroRow:      { flexDirection: 'row', alignItems: 'center', marginBottom: 8 },
  historyProteinBlock:  { marginRight: 16 },
  historyProteinNum:    { fontSize: 30, fontWeight: '900', color: '#4fc3f7', lineHeight: 32 },
  historyProteinLabel:  { fontSize: 10, fontWeight: '600', color: 'rgba(79,195,247,0.7)', marginTop: 1 },
  historySecondaryMacros:{ flexDirection: 'row', alignItems: 'center', gap: 6 },
  historyCalTxt:        { fontSize: 13, color: '#A0A0A0', fontWeight: '500' },
  historyDot:           { fontSize: 13, color: 'rgba(255,255,255,0.15)' },
  historyFatTxt:        { fontSize: 13, color: '#A0A0A0', fontWeight: '500' },
  historyFooter:        { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  historyDate:          { fontSize: 11, color: '#A0A0A0' },
  historyServings:      { fontSize: 11, fontWeight: '600', color: '#e0e0e0' },

  // ── Meal Session Cards (grouped history) ─────────────────────────────────
  mealSessionCard:       { backgroundColor: 'rgba(255,255,255,0.04)', borderRadius: 16, padding: 14, marginBottom: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
  mealSessionHeader:     { flexDirection: 'row', alignItems: 'flex-start', marginBottom: 10 },
  mealSessionTitle:      { fontSize: 15, fontWeight: '700', color: '#ffffff', marginBottom: 3 },
  mealSessionRestaurant: { fontSize: 11, fontWeight: '600', color: '#00796b', textTransform: 'uppercase', letterSpacing: 0.4 },
  mealSessionMeta:       { flexDirection: 'row', alignItems: 'center', marginLeft: 8, marginTop: 2 },
  mealSessionTime:       { fontSize: 11, color: '#A0A0A0' },
  mealSessionTotals:       { marginBottom: 4 },
  mealTotalProteinBlock:   { flexDirection: 'row', alignItems: 'baseline', gap: 3, marginBottom: 4 },
  mealTotalProteinNum:     { fontSize: 28, fontWeight: '900', color: '#4fc3f7', lineHeight: 30 },
  mealTotalProteinLabel:   { fontSize: 11, fontWeight: '600', color: 'rgba(79,195,247,0.65)' },
  mealTotalSecondary:      { flexDirection: 'row', alignItems: 'center', gap: 5 },
  mealTotalSecTxt:         { fontSize: 12, color: '#A0A0A0', fontWeight: '500' },
  mealTotalDot:            { fontSize: 12, color: 'rgba(255,255,255,0.15)' },
  mealExpandedWrap:      { borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.07)', marginTop: 10, paddingTop: 10, gap: 8 },
  mealItemRow:           { backgroundColor: 'rgba(255,255,255,0.04)', borderRadius: 10, padding: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)' },
  mealItemHeader:        { flexDirection: 'row', alignItems: 'flex-start', marginBottom: 8, gap: 6 },
  mealItemQty:           { fontSize: 13, fontWeight: '700', color: '#00796b', minWidth: 28 },
  mealItemName:          { fontSize: 13, fontWeight: '600', color: '#ffffff', flex: 1, lineHeight: 18 },
  mealItemMacroGrid:     { flexDirection: 'row', flexWrap: 'wrap', gap: 6 },
  mealMacroCell:              { backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: 7, paddingVertical: 5, paddingHorizontal: 8, alignItems: 'center', minWidth: 58 },
  mealMacroCellProtein:       { backgroundColor: 'rgba(79,195,247,0.1)', borderWidth: 1, borderColor: 'rgba(79,195,247,0.25)' },
  mealMacroCellVal:           { fontSize: 13, fontWeight: '700', color: '#ffffff' },
  mealMacroCellValProtein:    { fontSize: 15, fontWeight: '900', color: '#4fc3f7' },
  mealMacroCellLabel:         { fontSize: 9, fontWeight: '500', color: '#A0A0A0', marginTop: 1 },
  mealMacroCellLabelProtein:  { color: 'rgba(79,195,247,0.65)' },
  mealExpandHint:             { fontSize: 10, color: 'rgba(255,255,255,0.2)', textAlign: 'center', marginTop: 4 },
